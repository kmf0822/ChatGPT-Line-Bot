...
creds = Credentials.from_service_account_file(os.path.join(
    "src", "sheet-linebot-2a770e1250ba.json"),
                                              scopes=scope)
gs = gspread.authorize(creds)

sheet = gs.open_by_url(
    'https://docs.google.com/spreadsheets/d/12tsMYgX-gIF885hMDhgU9EK-WWwfXJp6P60o3KrYxuM/edit#gid=0'
)
...
def save_message(_model, _uid, _question, _answer):
  ...
  # 插入新的一行資料
  worksheet.insert_row([str(now), _model, _uid, _question, _answer],
                       last_row + 1)
